...
export class ContactDataService {
  data: Person[] = [
    new Person({
      ...
      email: 'chandarmani@technovert.com',
      mobile: '9292929292',
      land: '929292',
      web: 'www.technovert.com',
      house: `123 now here <br>
      Somestreet <br>
      Madhapur, hyderabad , 500033`}),
    new Person({
      name: 'Sasi Pagadala',
      email: 'sasaipagadala@technovert.com',
      mobile: '9292929292',
      land: '929292',
      web: 'www.technovert.com',
      house: `123 now here <br>
    ...
    new Person({
      name: 'Praveen Batula',
      email: 'praveenbatula@technovert.com',
      mobile: '9292929292',
      land: '929292',
      web: 'www.technovert.com',
      house: `123 now here <br>
    ...
    new Person({
      ...
      email: 'vijayyalamanchili@technovert.com',
      mobile: '9292929292',
      land: '929292',
      web: 'www.technovert.com',
      house: `123 now here <br>
